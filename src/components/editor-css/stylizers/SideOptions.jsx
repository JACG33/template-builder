const SideOptions = ({ setSplitType, split }) => {
  return (
    <div className='overflow-hidden rounded-lg flex justify-center w-fit'>
      <button type="button" data-splitype="joined" title="joined" onClick={e => setSplitType("joined")} className={`p-2 ${split == "joined" ? " bg-blue-500" : ""}`}>
      ...
      <button type="button" data-splitype="separated" title="separated" onClick={e => setSplitType("separated")} className={`p-2 ${split == "separated" ? "bg-blue-500" : ""}`}>
