const SideOptions = ({ setSplitType, split }) => {
  return (
    <div className='sideoption__wrap'>
      <button type="button" data-splitype="joined" title="joined" onClick={e => setSplitType("joined")} className={`sideoption__btn  ${split == "joined" ? " sideoption__btn--active" : ""}`}>
      ...
      <button type="button" data-splitype="separated" title="separated" onClick={e => setSplitType("separated")} className={`sideoption__btn  ${split == "separated" ? "sideoption__btn--active" : ""}`}>
