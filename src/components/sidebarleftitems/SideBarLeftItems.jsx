...
import SideBarElementsItems from "../addcomponents/SideBarElementsItems"
...
const SideBarLeftItems = () => {
  ...
  return (
    <>
      ...
      <div>
        <ButtonRight text={"Add Component"} handleShowComponents={handleShowComponents} type={"addcomp"}>
          <PlusIcon />
        </ButtonRight>
      </div>
      <div>
        <ButtonRight text={"Components Tree"} handleShowComponents={handleShowComponents} type={"tree"}>
          <ListTreeIcon />
        </ButtonRight>
      </div>
    </>
